...
#include <../dependancies/sdl/SDL_syswm.h>
#include <../dependancies/GL/glew.h>    // This example is using gl3w to access OpenGL functions (because it is small). You may use glew/glad/glLoadGen/etc. whatever already works for you.
